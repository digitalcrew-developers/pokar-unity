...
public class MenuScriptTournament : MonoBehaviour
{
    //DEV_CODE
    //private void Awake()
    //{
    ...
    public void OnClickOnButton(string eventName)
    {
        ...
        switch (eventName)
        {
            ...
            case "tableSettings":
                {
                    if (TournamentInGameUiManager.instance != null)
                        TournamentInGameUiManager.instance.ShowScreen(TournamentInGameScreens.TableSettings);
                }
                break;
            ...
            case "rules":
                if (TournamentInGameUiManager.instance != null)
                {
                    TournamentInGameUiManager.instance.ShowScreen(TournamentInGameScreens.HandRanking);
                }
                break;
