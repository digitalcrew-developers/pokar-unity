...
public class ClubDataManagerTeen : MonoBehaviour
{
    public static ClubDataManagerTeen instance;
    ...
    {
        //ClubAdminManagerTeen.instance.ShowScreen(ClubScreensTeen.GameData);
    }
    public void OnClickExpertData()
    {
        ClubAdminManagerTeen.instance.ShowScreen(ClubScreensTeen.ExpertData);
    }
}