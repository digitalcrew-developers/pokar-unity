...
public class ClubTemplateManagerTeen : MonoBehaviour
{
    public static ClubTemplateManagerTeen instance;

    public Toggle selectToggle;
    public Text templateName, gameMode, bootText, playerText, timeText, templateCounterText;
    public Button editButton, deleteButton, incrementBtn, decrementBtn;
    public GameObject editData, counterData;
