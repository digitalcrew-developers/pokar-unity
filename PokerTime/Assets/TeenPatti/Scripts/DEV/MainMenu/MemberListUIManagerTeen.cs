...
public class MemberListUIManagerTeen : MonoBehaviour
{
    public static MemberListUIManagerTeen instance;
    ...
    public List<ClubMemberDetailsTeen> newMembersList = new List<ClubMemberDetailsTeen>();
    public List<ClubMemberDetailsTeen> oldMembersList = new List<ClubMemberDetailsTeen>();
    ...
    private void Awake()
    {
        ...
        if(ClubDetailsUIManagerTeen.instance.playerTypeForClub.Equals("Creater"))
        {
    ...
    public void FetchMembersList()
    {
        string requestData = "{\"clubId\":\"" + ClubDetailsUIManagerTeen.instance.GetClubId() + "\"," +
                             ...
                             "\"Sequence\":\"" + "DESC" + "\"}";
        int limit = 0;
        string pendingUserRequestData = "{\"limit\":\"" +  limit.ToString() + "\"," + "\"clubId\":\"" + ClubDetailsUIManagerTeen.instance.GetClubId() + "\"}";

        //Debug.LogWarning("CLUB DETAILS CLUB ID-" + ClubDetailsUIManagerTeen.instance.GetClubId());
        //Debug.LogWarning("CLUB DETAILS UNIQUE CLUB ID-" + ClubDetailsUIManagerTeen.instance.GetClubUniqueId());


        //MainMenuController.instance.ShowScreen(MainMenuScreens.Loading);
        //old member list
        WebServices.instance.SendRequestTP(RequestTypeTP.GetClubMemberList, requestData, true, OnServerResponseFound);
        //WebServices.instance.SendRequest(RequestType.GetClubMemberList, requestData, true, (requestType, serverResponse, isShowErrorMessage, errorMessage) =>
        //{
        ...
        //new member list
        WebServices.instance.SendRequestTP(RequestTypeTP.GetPendingClubJoinRequest, pendingUserRequestData, true, OnServerResponseFound);
    }
    ...
    private void ShowMemberDetails(bool isShowNewMembers)
    {
        ...
        if (isShowNewMembers)
        {
            for (int i = 0; i < newMembersList.Count; i++)
            {
                ClubMemberDetailsTeen memberDetails = newMembersList[i];
    ...
    public void ChangeUserRole(GameObject gm,bool isDeleteRequest, ClubMemberDetailsTeen memberDetails,ClubMemberRole roleToAssign = ClubMemberRole.Member)
    {
        if (isDeleteRequest)
        {
            ...
            WebServices.instance.SendRequestTP(RequestTypeTP.DeleteUserClubJoinedRedquest, requestData, true, (requestType, serverResponse, isShowErrorMessage, errorMessage) =>
            {
        ...
        else
        {
            ...
            //MainMenuController.instance.ShowScreen(MainMenuScreens.Loading);
            WebServices.instance.SendRequestTP(RequestTypeTP.ChangePlayerRoleAndStatus, requestData, true, (requestType, serverResponse, isShowErrorMessage, errorMessage) =>
            {
                //MainMenuController.instance.DestroyScreen(MainMenuScreens.Loading);
    ...
    private ClubMemberDetailsTeen clubOwner;

    public ClubMemberDetailsTeen GetClubOwnerObject()
    {
        return clubOwner;
    }
...
[System.Serializable]
public class ClubMemberDetailsTeen
{
