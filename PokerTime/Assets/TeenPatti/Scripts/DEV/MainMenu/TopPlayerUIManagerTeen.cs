...
public class TopPlayerUIManagerTeen : MonoBehaviour
{
    ...
    private void ShowForumList(JsonData data)
    {
        ...
        for (int i = 0; i < data["getData"][0]["TopPlayers"].Count; i++)
        {
            ...
            {
                case 0:
                    gm1.GetComponent<TopPlayerUIContentTeen>().rankTxt.text = (i + 1).ToString();
                    GameObject g = Instantiate(gm1.GetComponent<TopPlayerUIContentTeen>().topRankImagePrefabs[0], gm1.GetComponent<TopPlayerUIContentTeen>().rankTxt.transform) as GameObject;
                    break;
                case 1:
                    gm1.GetComponent<TopPlayerUIContentTeen>().rankTxt.text = (i + 1).ToString();
                    GameObject g1 = Instantiate(gm1.GetComponent<TopPlayerUIContentTeen>().topRankImagePrefabs[1], gm1.GetComponent<TopPlayerUIContentTeen>().rankTxt.transform) as GameObject;

                    break;
                case 2:
                    gm1.GetComponent<TopPlayerUIContentTeen>().rankTxt.text = (i + 1).ToString();
                    GameObject g2 = Instantiate(gm1.GetComponent<TopPlayerUIContentTeen>().topRankImagePrefabs[2], gm1.GetComponent<TopPlayerUIContentTeen>().rankTxt.transform) as GameObject;
            ...
            gm1.GetComponent<TopPlayerUIContentTeen>().nameTxt.text = data["getData"][0]["TopPlayers"][i]["userName"].ToString();
            ...
            .setCached(false)
            .into(gm1.GetComponent<TopPlayerUIContentTeen>().nameImage)
            .start();
            }
            ...
            {
                case "LOBBY":
                    gm1.GetComponent<TopPlayerUIContentTeen>().goldTxt.text = data["getData"][0]["TopPlayers"][i]["TotalWinnings"].ToString();

                    break;
                case "MTT":
                    gm1.GetComponent<TopPlayerUIContentTeen>().goldTxt.text = data["getData"][0]["TopPlayers"][i]["TotalScore"].ToString();
                ...
                case "CLUB":
                    ...
                    break;
                case "BANKROLL":
                    gm1.GetComponent<TopPlayerUIContentTeen>().goldTxt.text = data["getData"][0]["TopPlayers"][i]["TotalCoins"].ToString();
