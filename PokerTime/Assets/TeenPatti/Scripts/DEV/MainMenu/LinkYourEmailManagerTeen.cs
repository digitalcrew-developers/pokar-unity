...
public class LinkYourEmailManagerTeen : MonoBehaviour
{
    public static LinkYourEmailManagerTeen instance;
    ...
    public void OnCloseLinkYourEmail()
    {
        ...
        MainMenuControllerTeen.instance.DestroyScreen(MainMenuScreensTeen.LinkYourEmail);
    }
    ...
    public void UnlinkBtnClick() 
    {
        ...
        MainMenuControllerTeen.instance.ShowScreen(MainMenuScreensTeen.UnlinkYourEmail);
    }
    ...
    {
        //MainMenuControllerTeen.instance.DestroyScreen(MainMenuScreens.Loading);
        ...
        if (requestType == RequestType.emailVerified)
        {
            ...
            if (data["success"].ToString()== "1")
            {
                ...
                else
                {
                    ...
                    MainMenuControllerTeen.instance.ShowScreen(MainMenuScreensTeen.LinkingSucessfull);
