...
public class ScrollSnapRectTeen : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler {

    public static ScrollSnapRectTeen instance;
    ...
    public void ChangeTxtVal() 
    {
        switch (this.gameObject.name)
        {
            case "YearScroll":
                ...
                changeIndexTxt.text = CareerManagerTeen.instance.currentYear.ToString();
                break;
            case "MonthScroll":
                //changeIndexTxt.text = "2020 - "+_currentPage + 1 ;
                changeIndexTxt.text = CareerManagerTeen.instance.currentYear + "-" + ((CareerManagerTeen.instance.currentMonth.ToString().Length == 1) ? "0" + CareerManagerTeen.instance.currentMonth.ToString() : CareerManagerTeen.instance.currentMonth.ToString());
                break;
            case "DayScroll":
        ...
        //Destroy(g);//Add By GP
        string date = CareerManagerTeen.instance.currentYear + "-" +
                      ((CareerManagerTeen.instance.currentMonth.ToString().Length == 1) ? "0" + CareerManagerTeen.instance.currentMonth.ToString() : CareerManagerTeen.instance.currentMonth.ToString()) + "-" +
                      ((CareerManagerTeen.instance.currentDate.ToString().Length == 1) ? "0" + CareerManagerTeen.instance.currentDate.ToString() : CareerManagerTeen.instance.currentDate.ToString());
    ...
    private void LerpToPage(int aPageIndex) 
    {
        ...
        if (aPageIndex < _currentPage)
        {
            if (containerScroll_Name.Equals("DayScroll"))
            {
                ...
                CareerManagerTeen.instance.currentDate--;
                if (CareerManagerTeen.instance.currentDate < 1)
                {
                    CareerManagerTeen.instance.currentMonth--;
                    CareerManagerTeen.instance.currentDate = DateTime.DaysInMonth(CareerManagerTeen.instance.currentYear, CareerManagerTeen.instance.currentMonth);
                }
            }
            else if (containerScroll_Name.Equals("MonthScroll"))
            {
                CareerManagerTeen.instance.currentMonth--;
                if(CareerManagerTeen.instance.currentMonth <1)
                {
                    CareerManagerTeen.instance.currentYear--;
                    CareerManagerTeen.instance.currentMonth = 12;
                }
            }
            else if (containerScroll_Name.Equals("YearScroll"))
            {
        ...
        else if (aPageIndex > _currentPage)
        {
            if (containerScroll_Name.Equals("DayScroll"))
            {
                ...
                CareerManagerTeen.instance.currentDate++;
                if (CareerManagerTeen.instance.currentDate > DateTime.DaysInMonth(CareerManagerTeen.instance.currentYear, CareerManagerTeen.instance.currentMonth))
                {
                    CareerManagerTeen.instance.currentMonth++;
                    CareerManagerTeen.instance.currentDate = 1;
                }
            }
            else if (containerScroll_Name.Equals("MonthScroll"))
            {
                CareerManagerTeen.instance.currentMonth++;
                if (CareerManagerTeen.instance.currentMonth > 12)
                {
                    CareerManagerTeen.instance.currentYear++;
                    CareerManagerTeen.instance.currentMonth = 1;
                }
            }
            else if (containerScroll_Name.Equals("YearScroll"))
            {
