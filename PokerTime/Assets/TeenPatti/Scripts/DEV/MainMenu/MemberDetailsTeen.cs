...
public class MemberDetailsTeen : MonoBehaviour
{
    public static MemberDetailsTeen instance;
    ...
    private ClubMemberDetailsTeen clubMemberDetails;
    ...
    /// screen is opened
    /// </summary>
    public void Initialise(ClubMemberDetailsTeen _clubMemberDetails, GameObject ListObject)
    {
        //DEV_CODE
    ...
    public void OnConfirmChangeMemberRole()
    {
        ...
        if (/*memberRole*/currentRole == ClubMemberRole.Agent)
        {
            ...
            //MemberListUIManagerTeen.instance.ChangeUserRole(ListObject, false, clubMemberDetails, memberRole);
        }
    ...
    public void ChangeMemberRole(ClubMemberRole roleToAssign)
    {
        ...
        WebServices.instance.SendRequestTP(RequestTypeTP.ChangePlayerRoleAndStatus, requestData, true, (requestType, serverResponse, isShowErrorMessage, errorMessage) =>
        {
            ...
            Debug.Log("Response => ChangeUserRoleAndStatus: " + serverResponse);
    ...
    private void DeleteMember()
    {
        ...
        TipsObj.transform.Find("BG1/BG2/ConfirmDeleteMember").GetComponent<Button>().onClick.AddListener(() =>
            //MemberListUIManagerTeen.instance.ChangeUserRole(ListObject, true, clubMemberDetails, clubMemberDetails.memberRole)
    ...
    public void OnServerResponseFound(RequestTypeTP requestType, string serverResponse, bool isShowErrorMessage, string errorMessage)
    {
        ...
        else if(requestType == RequestTypeTP.SendChipsOut)
        {
            ...
            if (data1["success"].Equals(1))
            {
                ...
                AgentSendOutPanel.transform.Find("BG1/BG2/SendOut/ChipsData/Text").GetComponent<Text>().text = ClubDetailsUIManagerTeen.instance.CLubChips.text;
        ...
        else if(requestType == RequestTypeTP.ClaimBackChips)
        {
        ...
        //    {
        //        MemberListUIManagerTeen.instance.ShowMemberDetails(data);
        //    }
        //    else
        //    {
        //        //MainMenuController.instance.ShowMessage(data["message"].ToString());
    ...
    {
        Debug.Log("Total Member list: " + MemberListUIManagerTeen.instance.oldMembersList.Count);
        Debug.Log("Owner Chips Count: " + ClubDetailsUIManagerTeen.instance.CLubChips.text);
