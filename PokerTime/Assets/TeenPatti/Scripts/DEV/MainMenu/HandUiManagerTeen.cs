...
public class HandUiManagerTeen : MonoBehaviour, IPointerDownHandler, IPointerUpHandler
{
    public static HandUiManagerTeen instance;
    ...
    public void OnClickBtnClose()
    {
        ...
        MainMenuControllerTeen.instance.DestroyScreen(MainMenuScreensTeen.HandScreen);        
    }
