...
public class SpinManagerTeenPatti : MonoBehaviour
{
    public static SpinManagerTeenPatti instance;
    ...
    {
        InGameUiManagerTeenPatti.instance.spinWheel.SetActive(true);
...
[System.Serializable]
public class SpinItemDataTeenPatti
{    
