...
public class HandHistoryUiManagerTeenPatti : MonoBehaviour
{
    public static HandHistoryUiManagerTeenPatti instance;
        ...
        for (int i = 0; i < data[0].Count; i++)
        {
            ...
            for (int j = 0; j < data[0][i]["logs"].Count; j++)
            {
                if (matchData.communityCards == null)
                {
                    ...
                    {
                        matchData.communityCards[k] = CardsManagerTeenPatti.instance.GetCardData(data[0][i]["logs"][j]["openCards"][k].ToString());
                    }
                }
                ...
                {
                    betHisory.playerCards[k] = CardsManagerTeenPatti.instance.GetCardData(data[0][i]["logs"][j]["playerCards"][k].ToString());
                }
...
[System.Serializable]
public class MatcHistoryDataTeenPatti
{
...
[System.Serializable]
public class UserBetHistoryTeenPatti
{
