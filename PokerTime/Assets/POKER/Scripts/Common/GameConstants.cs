...
//IP: 3.137.10.123
    ...
    public const string BASE_URL = "http://3.17.201.78";// "http://3.137.10.123";// //"http://18.191.15.121"; // "http://3.6.137.204";
    ...
    public const string GAME_PORTAL_URL = "http://3.17.201.78";// "http://3.137.10.123";// "http://3.17.201.78";//"http://18.191.15.121";//"http://3.6.137.204";
